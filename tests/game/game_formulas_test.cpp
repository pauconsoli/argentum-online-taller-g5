...
protected:
    ...
    Player human_mage{1, "Merlin", PlayerRace::HUMAN, PlayerClass::MAGE,
                      5, 100, 80, 10, 8, 16, 15, position};
    Player human_warrior{2, "Leonidas", PlayerRace::HUMAN, PlayerClass::WARRIOR,
                         5, 100, 80, 10, 8, 16, 15, position};
    Player elf_cleric{3, "Baelor", PlayerRace::ELF, PlayerClass::CLERIC,
                      5, 100, 80, 10, 8, 16, 15, position};
    Player dwarf_paladin{4, "Gimli", PlayerRace::DWARF, PlayerClass::PALADIN,
                         5, 100, 80, 10, 8, 16, 15, position};
};
...
TEST_F(GameFormulasTest, CalculateMaxHPLevel1) {
    Player level1_warrior{5, "NewbieWarrior", PlayerRace::HUMAN, PlayerClass::WARRIOR,
                          1, 100, 80, 10, 8, 16, 15, position};
    int max_hp = GameFormulas::calculate_max_hp(level1_warrior);
    EXPECT_EQ(max_hp, 22);
}

TEST_F(GameFormulasTest, CalculateMaxHPLevel10) {
    Player level10_warrior{6, "VeteranWarrior", PlayerRace::HUMAN, PlayerClass::WARRIOR,
                           10, 100, 80, 10, 8, 16, 15, position};
...
TEST_F(GameFormulasTest, CalculateMaxManaLevel1) {
    Player level1_mage{7, "NewbieMage", PlayerRace::HUMAN, PlayerClass::MAGE,
                       1, 100, 80, 10, 8, 16, 15, position};
...
TEST_F(GameFormulasTest, CalculateMaxManaLevel10) {
    Player level10_mage{8, "VeteranMage", PlayerRace::ELF, PlayerClass::MAGE,
                        10, 100, 80, 10, 8, 16, 15, position};
...
TEST_F(GameFormulasTest, CalculateMaxGoldLevel1) {
    Player level1{9, "Newbie", PlayerRace::HUMAN, PlayerClass::MAGE,
                  1, 100, 80, 10, 8, 16, 15, position};
...
TEST_F(GameFormulasTest, CalculateMaxGoldLevel5) {
    Player level5{10, "Explorer", PlayerRace::HUMAN, PlayerClass::MAGE,
                  5, 100, 80, 10, 8, 16, 15, position};
...
TEST_F(GameFormulasTest, CalculateMaxGoldLevel10) {
    Player level10{11, "Veteran", PlayerRace::HUMAN, PlayerClass::MAGE,
                   10, 100, 80, 10, 8, 16, 15, position};
...
TEST_F(GameFormulasTest, CalculateMaxGoldLevel20) {
    Player level20{12, "Legend", PlayerRace::HUMAN, PlayerClass::MAGE,
                   20, 100, 80, 10, 8, 16, 15, position};
...
TEST_F(GameFormulasTest, MaxGoldIncreaseWithLevel) {
    Player level1{13, "L1", PlayerRace::HUMAN, PlayerClass::MAGE,
                  1, 100, 80, 10, 8, 16, 15, position};
    Player level10{14, "L10", PlayerRace::HUMAN, PlayerClass::MAGE,
                   10, 100, 80, 10, 8, 16, 15, position};
    
    EXPECT_LT(GameFormulas::calculate_max_gold(level1),
              GameFormulas::calculate_max_gold(level10));
}

TEST_F(GameFormulasTest, MaxHPIncreaseWithLevel) {
    Player level1_warrior{15, "L1Warrior", PlayerRace::HUMAN, PlayerClass::WARRIOR,
                          1, 100, 80, 10, 8, 16, 15, position};
    Player level10_warrior{16, "L10Warrior", PlayerRace::HUMAN, PlayerClass::WARRIOR,
                           10, 100, 80, 10, 8, 16, 15, position};
...
TEST_F(GameFormulasTest, WarriorHasManaZero) {
    for (int i = 1; i <= 10; ++i) {
        Player warrior{static_cast<uint32_t>(100 + i), "Warrior",
                       PlayerRace::HUMAN, PlayerClass::WARRIOR,
                       i, 100, 80, 10, 8, 16, 15, position};
        EXPECT_EQ(GameFormulas::calculate_max_mana(warrior), 0);
    }
}

TEST_F(GameFormulasTest, NonWarriorsHaveMana) {
    Player mage{17, "Mage", PlayerRace::HUMAN, PlayerClass::MAGE,
                5, 100, 80, 10, 8, 16, 15, position};
    Player cleric{18, "Cleric", PlayerRace::HUMAN, PlayerClass::CLERIC,
                  5, 100, 80, 10, 8, 16, 15, position};
    Player paladin{19, "Paladin", PlayerRace::HUMAN, PlayerClass::PALADIN,
                   5, 100, 80, 10, 8, 16, 15, position};
...
TEST_F(GameFormulasTest, ElfMageHasMoreManaThanHumanMage) {
    Player human_mage{20, "HumanMage", PlayerRace::HUMAN, PlayerClass::MAGE,
                      5, 100, 80, 10, 8, 16, 15, position};
    Player elf_mage{21, "ElfMage", PlayerRace::ELF, PlayerClass::MAGE,
                    5, 100, 80, 10, 8, 16, 15, position};
...
TEST_F(GameFormulasTest, DwarfHasMoreHPThanElf) {
    Player elf_warrior{22, "ElfWarrior", PlayerRace::ELF, PlayerClass::WARRIOR,
                       5, 100, 80, 10, 8, 16, 15, position};
    Player dwarf_warrior{23, "DwarfWarrior", PlayerRace::DWARF, PlayerClass::WARRIOR,
                         5, 100, 80, 10, 8, 16, 15, position};
