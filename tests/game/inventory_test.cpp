...
protected:
    ...
    Player player{1, "Thoros of Myr", PlayerRace::HUMAN, PlayerClass::MAGE,
...
TEST_F(InventoryTest, UnequipWhenInventoryFull) {
    ...
    bool result = inventory.unequip(EquipmentSlot::WEAPON); // se hace el unequip pero el item se dropea porque el inventario está lleno
