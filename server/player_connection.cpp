...
void PlayerConnection::set_nick(const std::string& n) {
    nick = n;
}
...
void PlayerConnection::set_state(State new_state) {
    state.store(new_state);
}

uint32_t PlayerConnection::get_player_id() const {
    return player_id.load();
}

const std::string& PlayerConnection::get_nick() const {
    return nick;
}

uint32_t PlayerConnection::get_current_match_id() const {
    return current_match_id.load();
}

PlayerConnection::State PlayerConnection::get_state() const {
    return state.load();
}
